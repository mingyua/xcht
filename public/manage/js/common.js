  ...
  upload.render({
    ...
    ,before: function(obj){
     ...
     obj.preview(function(index, file, result){     
      ...
      if(item[0].id+'Img'=='upvideoImg' || item[0].id+'Img'=='upimgImg'){
      	var domain = window.location.host,path=res.data;
      	var path=path.replace(".\\","/");
      	$('#'+item[0].id+'Img').val(domain+path);
      }else{
